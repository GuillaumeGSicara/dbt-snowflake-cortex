...
def get_dbt_connection_info(profile_name: str, target_name: str) -> dict[str, str]:
    """Yields a dictionary of the connections
    from the dbt profiles.yml file in the root user directory.

    Args:
        profile_name (str): The name of the profile
            in the the profile.yml file.
        target_name (str): the name of the target
            in the profile.yml file (for the profile).

    Returns:
        dict[str, str]: a dictionary of the connection information
            for the profile and target
    """
...
def prepare_value_for_snowflake_insert(
    dict_value: str | list | int,
) -> str:
